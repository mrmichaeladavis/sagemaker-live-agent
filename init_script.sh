...
ingress:
    ...
    whip_base_url: https://whip.myhost.com/w
keys:
    APIQVsuCZRvdWEe: I6LCHJfE8OBA9D5yAqYhWMBYa1crCmHumfnUNJaLxRD
...
redis:
    ...
    cluster_addresses: []
    max_redirects: null
api_key: APIQVsuCZRvdWEe
api_secret: I6LCHJfE8OBA9D5yAqYhWMBYa1crCmHumfnUNJaLxRD
